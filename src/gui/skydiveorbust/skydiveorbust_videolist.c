...
//pg_sdobVideo_list[pg_sdobVideo_listConfig->cur]->path, 
    size_t serverUrlSz = snprintf(NULL, 0, "http://flittermouse.local/source/live/perris-fresh-meet-2022/%s", pg_sdobVideo_list[pg_sdobVideo_listConfig->cur]->name) + 1;
    char *serverUrl = (char *)malloc(serverUrlSz * sizeof(char));
    snprintf(serverUrl, serverUrlSz, "http://flittermouse.local/source/live/perris-fresh-meet-2022/%s", pg_sdobVideo_list[pg_sdobVideo_listConfig->cur]->name);
    printf("Server Url: %s\n", serverUrl);
