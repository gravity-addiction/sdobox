...
void pg_mainGuiInit(gslc_tsGui *pGui) {
  ...
  if ((
    pg_mainEl[E_MAIN_EL_BTN_A] = gslc_ElemCreateBtnTxt(pGui, GSLC_ID_AUTO, ePage,
            ...
            "Play", 0, E_FONT_MONO14, &pg_main_cbBtn_slideshow)
  ) != NULL) {
