...
sudo wget https://raw.githubusercontent.com/gravity-addiction/sdobox/tree/master/scripts/overlays/waveshare35c-overlay.dtb /boot/overlays/waveshare35c.dtbo
